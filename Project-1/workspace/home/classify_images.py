...
def classify_images(images_dir, results_dic, model):
    ...
    for filename, img_label in results_dic.items():
        ...
        match = img_label[0] in classifier_label
        
        # Add the results to the results dictionary (results_dic).
        img_label.extend([classifier_label, int(match)])
        results_dic[filename] = img_label
